 ...
 * 
 */
@WebServiceClient(name = "ServicioWeb", targetNamespace = "http://pckg/", wsdlLocation = "http://localhost:8080/E6_WebService/ServicioWeb?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICIOWEB_QNAME = new QName("http://pckg/", "ServicioWeb");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/E6_WebService/ServicioWeb?wsdl");
    ...
    public ServicioWeb getServicioWebPort() {
        return super.getPort(new QName("http://pckg/", "ServicioWebPort"), ServicioWeb.class);
    }
    ...
    public ServicioWeb getServicioWebPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://pckg/", "ServicioWebPort"), ServicioWeb.class, features);
    }
