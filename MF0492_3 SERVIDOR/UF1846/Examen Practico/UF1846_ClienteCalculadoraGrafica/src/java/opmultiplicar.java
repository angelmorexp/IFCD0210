 ...
 * @author aula1
 */
@WebServlet(urlPatterns = {"/opmultiplicar"})
public class opmultiplicar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try (PrintWriter out = response.getWriter()) {
            ...
            String jsonstring = multiplicar(n1,n2);
            JSONObject miobjeto = (JSONObject)JSONValue.parse(jsonstring);
            String producto= (String)miobjeto.get("producto");
            
            /* TODO output your page here. You may use following sample code. */

            request.setAttribute("pantallai", producto);
    ...
    private String multiplicar(java.lang.String n1, java.lang.String n2) {
