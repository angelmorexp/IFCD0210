 ...
 * @author aula1
 */
@WebServlet(urlPatterns = {"/opdividir"})
public class opdividir extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String jsonstring = dividir(n1,n2);
            JSONObject miobjeto = (JSONObject)JSONValue.parse(jsonstring);
            String division= (String)miobjeto.get("division");
            
            /* TODO output your page here. You may use following sample code. */

            request.setAttribute("pantallai", division);
    ...
    private String dividir(java.lang.String n1, java.lang.String n2) {
