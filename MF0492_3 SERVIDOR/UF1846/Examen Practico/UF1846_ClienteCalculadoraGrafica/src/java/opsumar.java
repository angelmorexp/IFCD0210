 ...
 * @author aula1
 */
@WebServlet(urlPatterns = {"/opsumar"})
public class opsumar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String jsonstring = sumar(n1,n2);
            JSONObject miobjeto = (JSONObject)JSONValue.parse(jsonstring);
            String suma= (String)miobjeto.get("suma");
            
            /* TODO output your page here. You may use following sample code. */
            
            request.setAttribute("pantallai", suma);
            request.setAttribute("paquete", jsonstring);
    ...
    private String sumar(java.lang.String n1, java.lang.String n2) {
