...
<body>
	...
	<h2>Lista de Usuarios</h2>
		<table>
			...
			<tr>
				...
				<td class="del"><a href="borrar.jsp?id=<%=rs.getInt("idUsuario")%>">&#x2716;</a></td>
				<td class="mod"><a href="modificar.jsp?id=<%=rs.getInt("idUsuario")%>">&#x270E;</a></td>
			</tr>
			<%
				}
			%>
	...
	<h2><a id="add" href="agregar.jsp">Ingresar nuevo usuario</a></h2>
