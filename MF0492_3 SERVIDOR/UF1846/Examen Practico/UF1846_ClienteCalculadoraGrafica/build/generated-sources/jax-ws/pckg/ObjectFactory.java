...
public class ObjectFactory {
    ...
    private final static QName _Dividir_QNAME = new QName("http://pckg/", "dividir");
    private final static QName _DividirResponse_QNAME = new QName("http://pckg/", "dividirResponse");
    private final static QName _Multiplicar_QNAME = new QName("http://pckg/", "multiplicar");
    private final static QName _MultiplicarResponse_QNAME = new QName("http://pckg/", "multiplicarResponse");
    private final static QName _Restar_QNAME = new QName("http://pckg/", "restar");
    private final static QName _RestarResponse_QNAME = new QName("http://pckg/", "restarResponse");
    private final static QName _Sumar_QNAME = new QName("http://pckg/", "sumar");
    private final static QName _SumarResponse_QNAME = new QName("http://pckg/", "sumarResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://pckg/", name = "dividir")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://pckg/", name = "dividirResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://pckg/", name = "multiplicar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://pckg/", name = "multiplicarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://pckg/", name = "restar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://pckg/", name = "restarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://pckg/", name = "sumar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://pckg/", name = "sumarResponse")
